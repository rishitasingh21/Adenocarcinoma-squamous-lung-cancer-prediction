...
results_dir=r"E:\rishita\code\trainmean_std\test\best_model_5"
models_dir = r"E:\rishita\code\trainmean_std\model"  # Folder where trained models are stored
...
model_path = os.path.join(models_dir, "model_fold_5.pth")
